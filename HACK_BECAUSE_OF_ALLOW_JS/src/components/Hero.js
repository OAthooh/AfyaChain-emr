      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-wrap gap-4">
            {['For Providers', 'For Patients', 'For Investors'].map((text) => (<button key={text} className="group flex items-center px-6 py-3 text-lg font-semibold rounded-lg bg-white text-blue-900 hover:bg-blue-50 transition-all duration-200">
                {text}
